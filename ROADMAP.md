...
- [x] דשבורד מאוחד (mainView `today`): KPI **hero = הכנסה כוללת השנה**; KPIs בסדר לוגי (פתיחה→עמלות→תשלומים→**יתרה לתשלום** מודגש); BarChart תזרים חודשי; **Donut פילוח לפי לקוח** עם מתג הכנסות/עמלות; קטע **"היום"** של ה-CRM (`ui.buildToday`). בלי טבלאות.
...
- [x] אימות Chromium + seed: דשבורד + אנליזה + מתגים + הרחבת שורות, נתונים עקביים (הכנסה 160,000 / עמלות 12,800 / יתרה 7,261), 0 שגיאות. SW `unified-v6`.
