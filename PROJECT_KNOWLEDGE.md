...
- **בלנדד**: `budgetCost / seniorHours` (כל התקציב על השעות שאינן ג'וניור), עם נפילה ל-`blendedAll`
  כשאין שעות בכירים. הנוסחה הקודמת `(תקציב − עלות ג'וניור)/שעות בכירים` הצטמצמה לממוצע הבכירים בלבד.
